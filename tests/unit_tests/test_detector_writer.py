...
class TestTryWriteFrames:
    ...
    def test_try_write_frames_success(self, writer, tmp_path, sample_frame_data, mock_nxopen):
    ...
    def test_try_write_frames_writes_pending_fields(self, writer, tmp_path, sample_frame_data, mock_nxopen):
...
class TestImageWriterTask:
    ...
    @pytest.mark.asyncio
    async def test_image_writer_retries_on_lock(self, writer, tmp_path, sample_frame_data):
    ...
    @pytest.mark.asyncio
    async def test_image_writer_batches_frames(self, writer, tmp_path, sample_frame_data):
...
class TestDetectorWriterClose:
    ...
    @pytest.mark.asyncio
    async def test_close_finalizes_with_links(self, writer, tmp_path, sample_frame_data, mock_nxopen):
...
class TestLinkResults:
    ...
    def test_link_results_creates_nxdata(self, writer):
        ...
        with patch("a1soft.ioc.NXdata") as mock_nxdata, \
